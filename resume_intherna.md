...
Detail-oriented tech professional with a solid foundation in **Software Engineering from 42 Barcelona** and a background as a **certified Mountain Guide**. 
Fully adapted to working and programming in international environments, I combine advanced technical skills—such as C programming, Linux environments, and Git—with strong, battle-tested soft skills. 
My experience leading groups in high-pressure natural environments has honed my ability to solve problems under pressure, manage risks, and communicate seamlessly in **English**. 
I am eager to leverage this unique combination of logical thinking, adaptability, and team leadership within a dynamic global tech environment.
